...
const EditHabitModal: React.FC<Props> = ({
  isOpen,
  onClose,
  habit,
  onHabitUpdated,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_BASE}/api/Habit/${habit.id}`, {
        method: "PUT",
        headers: {
                  ...
                  <div>
                    ...
                    >
                      <div className="relative">
                        ...
                        <Listbox.Options className="absolute mt-1 w-full bg-[#1b1526] border border-white/10 text-white rounded shadow-xl z-10 ring-1 ring-white/10 overflow-hidden">
