...
const CreateHabitModal: React.FC<Props> = ({isOpen, onClose, onHabitCreated}) => {
    const {token} = useAuth();
                                ...
                                <div>
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            <Listbox.Options
                                                className="absolute mt-1 w-full bg-[#1b1526] backdrop-blur-md border border-white/10 text-white rounded shadow-xl z-10 ring-1 ring-white/10 overflow-hidden">
